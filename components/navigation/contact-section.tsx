  ...
  return (
    <section className="container mx-auto px-6 text-center grid-pattern">
      <div className="max-w-2xl mx-auto py-20">
        ...
        <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-4 text-gradient leading-tight pb-2">¿Tenés un proyecto en mente?</h2>
        <p className="text-muted-foreground mb-8 text-base md:text-lg max-w-md mx-auto leading-relaxed">
        ...
        <div className="flex flex-col items-center gap-4">
          <Button
            asChild
            size="lg"
            className="rounded-full px-10 h-14 text-base font-bold shadow-2xl shadow-primary/20 hover:scale-105 transition-all duration-500 bg-primary"
          >
          ...
          <button 
            onClick={copyEmail}
            className="text-muted-foreground hover:text-foreground text-xs font-medium transition-colors border-b border-transparent hover:border-foreground/20 pb-0.5"
          >
